-- Backup script: dump config_entries BEFORE the IDP rename migration.
...
-- INSERT INTO public.config_entries (key, value, type, type_config, label_key, description_key, reserved, created_by)
-- VALUES
...
-- UPDATE public.config_entries SET key = 'casdoor_endpoint' WHERE key = 'idp_endpoint';
-- UPDATE public.config_entries SET key = 'casdoor_organization' WHERE key = 'idp_organization';
-- UPDATE public.config_entries SET key = 'casdoor_builtin_client_id' WHERE key = 'idp_client_id';
-- UPDATE public.config_entries SET key = 'casdoor_builtin_client_secret' WHERE key = 'idp_client_secret';
-- UPDATE public.config_entries SET key = 'oidc_issuer_type' WHERE key = 'idp_type';
