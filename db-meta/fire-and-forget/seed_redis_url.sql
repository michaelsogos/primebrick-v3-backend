-- Fire-and-forget: Seed redis_url in config_entries and update init patch SHA256.
--
-- The init patch was modified to add:
--   - redis_url seed row in config_entries
--
-- This script:
...
-- Reason: Added redis_url + enable_mfa seed rows to config_entries.
