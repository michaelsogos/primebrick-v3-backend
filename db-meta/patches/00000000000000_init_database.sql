...
('currency_favorites', 'EUR,USD,GBP,CHF,CNY,JPY', 'multi_select', '{"values_source":"currencies","value_field":"code","label_field":"name","validation":{"required":false,"rules":{}}}', 'config.auth.currency_favorites.label', 'config.auth.currency_favorites.description', true, 'system_settings', 'system')
